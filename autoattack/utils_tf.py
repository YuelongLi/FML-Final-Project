...
class ModelAdapter():
    ...
    def grad_logits(self, x):
        ...
        return torch.from_numpy(logits), torch.from_numpy(g2)
    ...
    def get_grad_diff_logits_target(self, x, y=None, y_target=None):
        ...
        return torch.from_numpy(dl), torch.from_numpy(g2)
    ...
    def get_logits_loss_grad_xent(self, x, y):
        ...
        return torch.from_numpy(logits_val), torch.from_numpy(loss_indiv_val), torch.from_numpy(grad_val)
